<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/cmsite', query: {geohash}})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('cmsite') !== -1? '#msiteActive' : '#msite'"></use>
            </svg>
            <span>外卖</span>
        </section>
